...
export default function DropZone({ onFileAccepted, isUploading, uploadProgress }) {
      ...
      >
        ...
        >
          {isUploading ? (
            ...
            <div>
              <div style={{ color: isDragReject ? 'var(--red)' : 'var(--text-3)', marginBottom: 16 }}>
                <FileSpreadsheet size={44} strokeWidth={1} />
              </div>
